...
<body>
<script src="/static/js/toSaveMoney.js"></script>
<div class="wrapper" >
    <article>
          <h1><em></em><span>ATM系统存钱</span></h1>
           <div class="main">
               <form action="saveMoney" method="post" id="form">
                   <div class="tel">
                   ...
                   <div class="tel">
                      ...
                      请输入存入金额： <input type="text" name="transMoney" id="transMoney"  placeholder="存入金额">
